...
{
    internal class ExtendClearCoatShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent flakesBumpMapText = EditorGUIUtility.TrTextContent("FlakesBumpMap", "");
            public static GUIContent flakesBumpMapScaleText = EditorGUIUtility.TrTextContent("FlakesBumpMapScale", "");
            public static GUIContent flakesBumpStrengthText = EditorGUIUtility.TrTextContent("FlakesBumpStrength", "");
            public static GUIContent reflectionSpecularText = EditorGUIUtility.TrTextContent("ReflectionSpecular", "");
            public static GUIContent reflectionGlossinessText = EditorGUIUtility.TrTextContent("ReflectionGlossiness", "s");

            public static string primaryMapsText = "Main Maps";
            public static string secondaryMapsText = "Secondary Maps";
            public static string renderingMode = "Rendering Mode";
            public static string advancedText = "Advanced Options";
            public static string clearCoatAreaText = "ClearCoat Area";
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                GUILayout.Label(Styles.clearCoatAreaText, EditorStyles.boldLabel);
