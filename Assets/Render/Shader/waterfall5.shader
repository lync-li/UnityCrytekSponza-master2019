        ...
        Pass {
           ...
           // #pragma only_renderers d3d9 d3d11 glcore gles gles3 metal 
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_9715 = _Time + _TimeEditor;
                float2 node_4473 = (o.uv0+node_9715.g*float2(0,0.001));
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_9715 = _Time + _TimeEditor;
                float2 node_5440 = (i.uv0+node_9715.g*float2(0,0));
                float3 node_3910 = UnpackNormal(tex2D(_node_2968,TRANSFORM_TEX(node_5440, _node_2968)));
                float2 node_9526 = (i.uv0+node_9715.g*float2(0.003,0.005));
...
/////// Diffuse:
                ...
                float2 node_3868 = ((i.uv0*_node_7670)+node_9715.g*float2(0.001,0));
                float4 node_4180 = tex2D(_node_2925,TRANSFORM_TEX(node_3868, _node_2925));
                float2 node_4473 = (i.uv0+node_9715.g*float2(0,0.001));
        ...
        Pass {
           ...
           // #pragma only_renderers d3d9 d3d11 glcore gles gles3 metal 
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv2 = v.texcoord2;
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_6250 = _Time + _TimeEditor;
                float2 node_4473 = (o.uv0+node_6250.g*float2(0,0.001));
                float4 _node_1460_var = tex2Dlod(_node_1460,float4(TRANSFORM_TEX(node_4473, _node_1460),0.0,0));
                v.vertex.xyz += lerp((_node_1460_var.rgb*_node_9010*v.normal),float3(0,0,0),_node_8926);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
                o.pos = UnityObjectToClipPos( v.vertex );
        ...
        Pass {
          ...
          //  #pragma only_renderers d3d9 d3d11 glcore gles gles3 metal 
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv2 = v.texcoord2;
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_5204 = _Time + _TimeEditor;
                float2 node_4473 = (o.uv0+node_5204.g*float2(0,0.001));
                float4 _node_1460_var = tex2Dlod(_node_1460,float4(TRANSFORM_TEX(node_4473, _node_1460),0.0,0));
                v.vertex.xyz += lerp((_node_1460_var.rgb*_node_9010*v.normal),float3(0,0,0),_node_8926);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 node_5204 = _Time + _TimeEditor;
                float2 node_3868 = ((i.uv0*_node_7670)+node_5204.g*float2(0.001,0));
                float4 node_4180 = tex2D(_node_2925,TRANSFORM_TEX(node_3868, _node_2925));
                float2 node_4473 = (i.uv0+node_5204.g*float2(0,0.001));
                float4 node_9839 = tex2D(_node_2925,TRANSFORM_TEX(node_4473, _node_2925));
