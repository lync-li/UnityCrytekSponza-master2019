...
#ifndef EXTEND_UNITY_STANDARD_BRDF_INCLUDED
#define EXTEND_UNITY_STANDARD_BRDF_INCLUDED
...
inline half RoughnessToPerceptualRoughness(half roughness)
{
    ...
    half4 sssTex)
{
    ...
    //brdfUV.y = curvature * dot(light.color, half3(0.0396819152, 0.458021790, 0.00609653955));
	brdfUV.y = curvature * dot(LinearToGammaSpace(light.color), half3(0.22, 0.707, 0.071));
	...
	//	Final composition
    half4 c = 0;
    c.rgb = diffColor * light.color * brdf // diffuse
                + gi.diffuse * diffColor
			//	#if defined (DIRECTIONAL) && defined (LUX_DIRECTIONAL_SSS) || defined (DIRECTIONAL_COOKIE) && defined (LUX_DIRECTIONAL_SSS) || defined (POINT) && defined (LUX_POINT_SSS) || defined (POINT_COOKIE) && defined (LUX_POINT_SSS) || defined (SPOT) && defined (LUX_SPOT_SSS)
			    + lightScattering
			//	#endif																				// translucency
