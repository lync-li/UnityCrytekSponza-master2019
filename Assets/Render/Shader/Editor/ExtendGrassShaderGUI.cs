...
{
    internal class ExtendGrassShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
			...
			public static GUIContent moveRangeText = EditorGUIUtility.TrTextContent("MoveRange", "");
			public static GUIContent moveRandomText = EditorGUIUtility.TrTextContent("MoveRandom", "");
			public static GUIContent moveRateText = EditorGUIUtility.TrTextContent("MoveRate", "");

            public static string primaryMapsText = "Main Maps";
            public static string secondaryMapsText = "Secondary Maps";
            public static string renderingMode = "Rendering Mode";
            public static string advancedText = "Advanced Options";
			public static string grassAreaText = "Grass Area";
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                GUILayout.Label(Styles.grassAreaText, EditorStyles.boldLabel);
                DoGrassArea(material);
            }
            if (EditorGUI.EndChangeCheck())
            {
                foreach (var obj in blendMode.targets)
        ...
        void DoAlbedoArea(Material material)
        {
            ...
            if (((BlendMode)material.GetFloat("_Mode") == BlendMode.CutoutDoubleSide))
            {
        ...
        void DoGrassArea(Material material)
        {

            m_MaterialEditor.ShaderProperty(moveRange, Styles.moveRangeText);
            m_MaterialEditor.ShaderProperty(moveRate, Styles.moveRateText);
            m_MaterialEditor.ShaderProperty(moveRandom, Styles.moveRandomText);
        ...
        public static void SetupMaterialWithBlendMode(Material material, BlendMode blendMode)
        {
            switch (blendMode)
            {
                ...
                case BlendMode.FadeDoubleSide:
                    ...
                    break;
                case BlendMode.TransparentDoubleSide:
                    material.SetOverrideTag("RenderType", "Transparent");
                    material.SetInt("_SrcBlend", (int)UnityEngine.Rendering.BlendMode.One);
                    material.SetInt("_DstBlend", (int)UnityEngine.Rendering.BlendMode.OneMinusSrcAlpha);
                    material.SetInt("_ZWrite", 0);
