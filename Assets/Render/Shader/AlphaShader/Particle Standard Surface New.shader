...
Shader "Particles/Standard Surface New"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        BlendOp [_BlendOp]
        Blend [_SrcBlend] [_DstBlend], Zero [_DstBlend]
        ZWrite [_ZWrite]
        Cull [_Cull]
	...
	#pragma multi_compile __ _ALPHABUFFER
        ...
        #include "../ExtendShader/ExtendUnityStandardParticles.cginc"
        ENDCG
    }

    Fallback "VertexLit"
    CustomEditor "ExtendStandardParticlesShaderGUI"
}
