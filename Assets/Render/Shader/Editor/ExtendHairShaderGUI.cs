...
{
    internal class ExtendHairShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent anisoMapText = EditorGUIUtility.TrTextContent("_AnisoMap", "");
            public static GUIContent adjustText = EditorGUIUtility.TrTextContent("_Adjust", "");
            public static GUIContent tangentDirText = EditorGUIUtility.TrTextContent("_TangentDir", "");
            public static GUIContent anisoGloss1Text = EditorGUIUtility.TrTextContent("_AnisoGloss1", "");
            public static GUIContent anisoSpec1Text = EditorGUIUtility.TrTextContent("_AnisoSpec1", "");
            public static GUIContent anisoGloss2Text = EditorGUIUtility.TrTextContent("_AnisoGloss2", "");
            public static GUIContent anisoSpec2Text = EditorGUIUtility.TrTextContent("_AnisoSpec2", "");
            public static GUIContent tangentShift1Text = EditorGUIUtility.TrTextContent("_TangentShift1", "");
            public static GUIContent tangentShift2Text = EditorGUIUtility.TrTextContent("_TangentShift2", "");
            public static string primaryMapsText = "Main Maps";
            public static string secondaryMapsText = "Secondary Maps";
            public static string renderingMode = "Rendering Mode";
            public static string advancedText = "Advanced Options";
            public static string hairAreaText = "Hair Area";
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            adjust = FindProperty("_Adjust", props);
        ...
        {
            m_MaterialEditor.TexturePropertySingleLine(Styles.anisoMapText, anisoMap, adjust);

            m_MaterialEditor.ShaderProperty(tangentDir, Styles.tangentDirText);
            m_MaterialEditor.ShaderProperty(anisoGloss1, Styles.anisoGloss1Text);
            m_MaterialEditor.ShaderProperty(anisoSpec1, Styles.anisoSpec1Text);
            m_MaterialEditor.ShaderProperty(tangentShift1, Styles.tangentShift1Text);
            m_MaterialEditor.ShaderProperty(anisoGloss2, Styles.anisoGloss2Text);
            m_MaterialEditor.ShaderProperty(anisoSpec2, Styles.anisoSpec2Text);
            m_MaterialEditor.ShaderProperty(tangentShift2, Styles.tangentShift2Text);
        }
