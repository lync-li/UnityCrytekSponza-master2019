...
{
    internal class ExtendSSSShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent BRDFTexText = EditorGUIUtility.TrTextContent("BRDFTex", "");
            public static GUIContent SSSTexText = EditorGUIUtility.TrTextContent("SSSTex", "");
            public static GUIContent curvatureScaleText = EditorGUIUtility.TrTextContent("CurvatureScale", "");
            public static GUIContent thicknessScaleText = EditorGUIUtility.TrTextContent("ThicknessScale", "");
            public static GUIContent subColorText = EditorGUIUtility.TrTextContent("SubColor", "");
            public static GUIContent powerText = EditorGUIUtility.TrTextContent("Power", "");
            public static GUIContent distortionText = EditorGUIUtility.TrTextContent("Distortion", "");

            public static string primaryMapsText = "Main Maps";
            public static string secondaryMapsText = "Secondary Maps";
            public static string renderingMode = "Rendering Mode";
            public static string advancedText = "Advanced Options";
            public static string skinAreaText = "skin Area";
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            BRDFTex = FindProperty("_BRDFTex", props);
            SSSTex = FindProperty("_SSSTex", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                GUILayout.Label(Styles.skinAreaText, EditorStyles.boldLabel);
                DoSkinArea(material);
            }
            if (EditorGUI.EndChangeCheck())
            {
        ...
        void DoSkinArea(Material material)
        {
            ...
            //if (hadTexture)
            {
                m_MaterialEditor.ShaderProperty(BRDFTex, Styles.BRDFTexText);
                m_MaterialEditor.ShaderProperty(SSSTex, Styles.SSSTexText);
                m_MaterialEditor.ShaderProperty(curvatureScale, Styles.curvatureScaleText);
                m_MaterialEditor.ShaderProperty(thicknessScale, Styles.thicknessScaleText);
                m_MaterialEditor.ShaderProperty(subColor, Styles.subColorText);
