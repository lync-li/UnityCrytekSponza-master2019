#ifndef UNITY_POSTFX_COLOR222
#define UNITY_POSTFX_COLOR222
...
//
half Luminance2(half3 linearRgb)
{
    return dot(linearRgb, float3(0.2126729, 0.7151522, 0.0721750));
}

half Luminance2(half4 linearRgba)
{
    return Luminance2(linearRgba.rgb);
}
